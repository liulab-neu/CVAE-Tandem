...
networks do not share a cell and their logs come from three different runs:
  ...
  DNN_FNN-t.txt      forward   w_peak-wavelength=100  w_peak-intensity=1
  DNN_tandem-t.txt   tandem    w_peak-wavelength=1    w_peak-intensity=0
  CVAE_loss.txt      CVAE      w_peak-wavelength=1    w_peak-intensity=100

The logs directly under 1peak/ belong to a different run and do not match the
